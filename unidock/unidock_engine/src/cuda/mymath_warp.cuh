...
__device__ __forceinline__ void init_tri_mat_tile(const cooperative_groups::thread_block_tile<TILE_SIZE> &tile,
                                                 Real *m, int dim, Real fill_data) {
...
__device__ __forceinline__ void set_tri_mat_diagonal_tile(const cooperative_groups::thread_block_tile<TILE_SIZE> &tile,
                                                    Real *m, int dim, Real fill_data) {
