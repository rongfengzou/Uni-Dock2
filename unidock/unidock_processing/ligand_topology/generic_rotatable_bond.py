...
class GenericRotatableBond(object):
    def __init__(self):
        ...
        self.conjugate_aryl_amide_smarts_1 = '[c,n;$(a:[c&H1,n&H0&D2])]-[C;$(C(=[O,S])N)]'
        self.conjugate_aryl_amide_smarts_2 = '[c,n;$(a:[c&H1,n&H0&D2])]-[N;$(NC(=[O,S]))]'
        ...
        self.conjugate_aryl_amide_pattern_1 = Chem.MolFromSmarts(self.conjugate_aryl_amide_smarts_1)
        self.conjugate_aryl_amide_pattern_2 = Chem.MolFromSmarts(self.conjugate_aryl_amide_smarts_2)
...
#        exclude_rotatable_bond_info_list += list(mol.GetSubstructMatches(self.carboxyl_bond_pattern))
        exclude_rotatable_bond_info_list += list(mol.GetSubstructMatches(self.phosphate_bond_pattern))

#        exclude_rotatable_bond_info_list += list(mol.GetSubstructMatches(self.conjugate_aryl_amide_pattern_1))
#        exclude_rotatable_bond_info_list += list(mol.GetSubstructMatches(self.conjugate_aryl_amide_pattern_2))
