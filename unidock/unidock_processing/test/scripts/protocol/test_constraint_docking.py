...
def receptor_RNA_case():
    return os.path.join(
        ...
        "constraint_docking",
        "RNA_case",
        "test_receptor_topology_RNA.pdb",
    )
...
def ligand_RNA_case():
    data_file_dir_name = os.path.join(
        os.path.dirname(__file__), "..", "..", "data", "constraint_docking", "RNA_case"
    )
    ligand_sdf_file_name = os.path.join(data_file_dir_name, "ligand.sdf")
    ligand_sdf_file_name_list = [ligand_sdf_file_name]
...
def test_automatic_case(
    receptor_automatic_case,
    ...
    unidock2_option_dict["Preprocessing"]["reference_sdf_file_name"] = (
        reference_automatic_case
    )
...
def test_manual_case(
    ...
    unidock2_option_dict["Preprocessing"]["core_atom_mapping_dict_list"] = (
        core_atom_mapping_manual_case
    )
